...
$url = "https://github.com/Anonymous69Attack/Holis/blob/main/static/patches.json"
$retries = 0
...
if ($test_js) {
    ...
    If ($xpui_test_js -match 'Crack by MrGarabato') {
...
If ($test_spa) {
    ...
    If ($patched_by_spotx -match 'Crack by MrGarabato') {
        $zip.Dispose()    
